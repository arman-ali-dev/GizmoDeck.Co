...
import { upsertCoupon } from "../../../store/admin/couponSlice";
...
const EditCouponForm = ({ handleClose, selectedCoupon }) => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      startDate: selectedCoupon?.startDate
        ? dayjs(selectedCoupon.startDate)
        : null,
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      try {
        ...
        toast.success("Coupon updated successfully!", { autoClose: 1500 });

        dispatch(upsertCoupon(data));
        handleClose();
        resetForm();
      } catch (err) {
        const errorMessage =
