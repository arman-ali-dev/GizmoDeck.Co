...
const NoAddressFound = () => {
  return (
    <div className="w-full flex flex-col items-center justify-center py-44 text-center">
      <svg
        fill="#000000"
        height="70px"
        width="70px"
